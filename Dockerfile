...
RUN chmod u=rwx,go=rx /usr/local/bin/* \
 ...
 && adduser user root \
 && chmod g+x /root \
 && mkdir -p /usr/local/src /etc/dropbear /qwc2 /qwc2conf /run/secrets /home/user/.ssh /home/user/.cache /home/user/.config/yarn/global /home/user/.config/yarn/link /root/.config/yarn \
 ...
 && ln -s /home/user/.config/yarn/link /root/.config/yarn/link \
